...
?>
    ...
    <?php
        ...
        $redirect_url = str_replace($url,'save_password.php', '');
        ...
        if (isset($_POST['password']) && isset($_POST['password1']) && isset($_POST['password2'])) {
            if(empty($_POST['password']) || empty($_POST['password1'] || empty($_POST['password2']))){
               return Redirect($redirect_url.'edit_account.php?departmentid='.$departmentID.'&stat=4', false);
            }
            ...
            if ($password === $pass) {
                ...
                while ($row2 = mysqli_fetch_assoc($result2)) {
                    ...
                    if ($password1 === $password2) {
                        ...
                        Redirect($redirect_url.'profile.php?'.'stat=3', false);
                        ...
                        Redirect($redirect_url.'edit_account.php?departmentid='.$departmentID.'&stat=1', false);
                    }
                }
            } else {
                Redirect($redirect_url.'edit_account.php?departmentid='.$departmentID.'&stat=2', false);
            ...
            Redirect($redirect_url.'edit_account.php?departmentid='.$departmentID.'&stat=3', false);
